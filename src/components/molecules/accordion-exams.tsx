...
export function AccordionExams({
  ...
  const biomicroscopyPresetNormal =
    "Pálpebras e anexos: sem alterações;\n" +
    "Conjuntiva: sem alterações;\n" +
    "Córnea: transparente;\n" +
    "Câmara anterior: profunda e quieta, células 0, flare 0;\n" +
    "Íris: sem alterações;\n" +
    "Cristalino: transparente;\n" +
    "Vítreo: sem alterações.";
  ...
  const setBiomicroscopyPresetNormal = useCallback(
    ...
    [form, biomicroscopyPresetNormal],
  );

  // Preset e frases rápidas para Fundoscopia
  const fundoscopyPresetNormal =
    "Nervo óptico: cor e escavação preservadas;\n" +
    "Mácula: sem alterações;\n" +
    "Vasos: trajeto e calibre preservados;\n" +
    "Polo posterior: aplicado;";

  const setFundoscopyPresetNormal = useCallback(
    (fieldName: keyof EvaluationMainFormValues) => {
      form.setValue(fieldName, fundoscopyPresetNormal, { shouldDirty: true });
    },
    [form, fundoscopyPresetNormal],
  );
        ...
        >
            ...
            <AccordionContent className="flex flex-col gap-4 px-2">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="w-full">
                  ...
                  {/* Removed add-findings button (OD) */}
                  <FormField
                    control={form.control}
                ...
                <div className="w-full">
                  ...
                  {/* Removed add-findings button (OS) */}
                  <FormField
                    control={form.control}
          ...
          <AccordionItem value="fundoscopy">
            ...
            <AccordionContent className="flex flex-col gap-4 px-2">
              ...
              {/* Removed FindingsBuilder - Fundoscopia */}
            </AccordionContent>
          </AccordionItem>
          {/* TONOMETRIA */}
